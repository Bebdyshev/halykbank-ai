...
Запас против 3-часового окна — ~1.7×: ОДИН полный холодный прогон + время на
проверки и сдачу. Второй полный прогон не влезает — при сбое перезапускаться
из кэша (см. план Б), а не с нуля.
